...
description: Turn a product designer's rough idea into a structured markdown design spec ready to paste into a prototyping tool (Figma Make, Stitch, v0, Pencil, etc.). Use this whenever the user wants to design a new app, product, or feature; says things like "I want to build an app that...", "help me design...", "I have an idea for..."; asks for a PRD or design spec for a UI; or mentions generating a prototype. Prefer this over generic spec writing whenever the end goal is a clickable prototype.
---

# Idea to Prototype

This skill turns a designer's initial product thoughts into a structured design spec that can be pasted into a prototyping tool to generate relevant prototypes. Strictly follow the steps below in order.
...
This must be the very first question asked after the skill is invoked.
...
If the user's input is incomplete or unclear, ask follow-up questions to ensure there is enough information to create a meaningful spec.
